...
class TestEditLandmarkOrder(unittest.TestCase):
    ...
    def test_swap_landmark_after_game_starts(self):
        self.assertEqual(game_started, self.cli.command("start"), "Failed to start game.")
        self.assertEqual(edit_landmark_order_fail, self.cli.command("editlandmarkorder 2 10"),
                         "Failed to change landmark order")
...
class TestSnapShot(unittest.TestCase):
    ...
    def test_snapshot_not_gm(self):
        ...
        self.assertEqual(logout, self.cli.command("logout"), "logout message not correct")
        self.assertEqual(login_success, self.cli.command("login Team1 1526"), "Failed to log in ")
        self.assertEqual(permission_denied, self.cli.command("snapshot"), "Not Game Maker!!")
