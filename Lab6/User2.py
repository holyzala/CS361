...
class TestCanAccess(unittest.TestCase):
    ...
    def test_canAccessFalse(self):
        ...
        self.assertFalse(self.user.can_access(self.accessor), "User incorrectly granted access")

    def test_canAccessTrue(self):
        self.user.accessList = [self.accessor]
        self.assertTrue(self.user.can_access(self.accessor), "User incorrectly denied acccess")
